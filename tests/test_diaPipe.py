...
class TestDiaPipelineTask(unittest.TestCase):
    ...
    def test_filterDiaObjects(self):
        ...
        diaSources["reliabilityVersion"] = '99.42'
    ...
    def testRunWithForcedMeasurement(self):
        ...
        diaSourcesGood['reliabilityVersion'] = '99.42'
        ...
        diaSourcesBad['reliabilityVersion'] = '99.42'
    ...
    def test_selectGoodObjects(self):
        ...
        diaSourcesNotMatched['reliability'] = (self.rng.random(nDiaSources)*(1 - reliabilityThreshold)
                                               + reliabilityThreshold)
        diaSourcesNotMatched['reliabilityVersion'] = '99.42'
