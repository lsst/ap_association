...
def _data_file_name(basename):
    ...
    """
    import os
    return os.path.join(os.environ.get("AP_ASSOCIATION_DIR"), "data", basename)


# SQLAlchemy database connection URI
config.db_url = "sqlite:///l1dbproto.db"
...
config.schema_file = _data_file_name('l1db-ap-pipe-schema.yaml')
...
config.column_map = _data_file_name('l1db-ap-pipe-afw-map.yaml')
