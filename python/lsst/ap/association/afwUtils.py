...
def make_dia_object_schema(filter_names=None):
    ...
    schema.addField('gPSFluxMedian', type='F',
    ...
    schema.addField('rPSFluxMedian', type='F',
    ...
    schema.addField('iPSFluxMedian', type='F',
    ...
    schema.addField('zPSFluxMedian', type='F',
    ...
    schema.addField('yPSFluxMedian', type='F',
